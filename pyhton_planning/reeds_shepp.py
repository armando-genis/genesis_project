...
def calc_optimal_path(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=STEP_SIZE):
    ...
    # print the sx and the sy values
    print("sx: ", sx)
    print("sy: ", sy)
    print("syaw: ", syaw)
...
def calc_all_paths(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=STEP_SIZE):
    ...
    #print the path.ctypes
    print("path.ctypes: ", paths[0].ctypes)

    # print the q0 and q1 values
    print("q0: ", q0)
    print("q1: ", q1)



    # print the varibale type of ctypes
    print("type of ctypes: ", type(paths[0].ctypes))
    ...
    # print final path lenght
    print("final path lenght: ", path.L)
...
def main():
    ...
    # simulation-2
    states = [(0, 0, 0), (10, 0, 0), (20, 13, 30), (20, 5, -25),
              (35, 10, 120), (32, -10, 180), (5, -12, 90)]
    ...
    print("Path x length:", len(path_x))
    print("Path y length:", len(path_y))
    print("Yaw length:", len(yaw))
